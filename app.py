...
YUNTECH_ALL_DEPTS = ["不限科系/共同通識核心", "機械工程系", "電機工程系", "電子工程系", "資訊工程系", "環境與安全衛生工程系", "化學工程與材料工程系", "營建工程系", "工業工程與管理系", "企業管理系", "資訊管理系", "財務金融系", "會計系", "工商管理學士學位學程", "國際管理學士學位學程", "工業設計系", "視覺傳達設計系", "數位媒體設計系", "建築與室內設計系", "創意生活設計系", "應用外語系", "文化資產維護系", "前瞻學士學位學程"]
